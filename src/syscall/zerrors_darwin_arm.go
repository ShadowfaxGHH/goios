// Edited output of mkerrors.sh
// 1. grep ARM in types_darwin.go for missing pieces in iOS headers
// 2. O_CLOEXEC isn't supported, but should be defined as 0 for os/file_unix.go 
...
const (
	...
	O_ASYNC                     = 0x40
	//O_CLOEXEC                   = 0x1000000
	O_CLOEXEC                   = 0x0 // Darwin/ARM doesn't respect this flag
	O_CREAT                     = 0x200
